...
%     end
    ...
    for i=1:N
        factor_graph_L(i,n+1)=y(i);
    end
    
    %initialization LHS. frozen=0->infinity, frozen=1->-infinity, message->0
    factor_graph_R = zeros(N,n+1);
    for i=1:N
        if PCparams.FZlookup(i) == 0
...
%     end
    ...
    for i=1:num_itert
        ...
        for j=n:-1:1 %iteration from left most column to right most column
            ...
            for k=1:number_of_blocks
                for L=1:number_per_block
                    ...
                    factor_graph_L(row_1,col_1)=...
                     BP_xor_function(factor_graph_L(row_2,col_2)+factor_graph_R(row_2,col_1),factor_graph_L(row_2,col_1));
